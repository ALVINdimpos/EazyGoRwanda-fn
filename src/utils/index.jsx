...
const dateFormater = (value, dateFormat = 'MMM Do YYYY', timeFormat = 'hh:mm') => {
  return (
...
const hasRequiredRole = (user, requiredRoles) => requiredRoles.some(role => user.roles.includes(role));
